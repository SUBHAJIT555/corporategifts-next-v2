...
const technologyAndAccessoriesFeatures: FeatureCard[] = [
  ...
  },
  {
    ...
    iconColor: "#DCEDC8", // highlight (very light green-yellow)
  },
  {
    id: 5,
    number: "05",
    ...
    iconColor: "#B2B7FF", // highlight (very light indigo/blue)
  },
  {
    id: 6,
    number: "06",
...
export default async function TechnologyAndAccessories() {
  const page = 1;
  const { categories, productData } = await getTechnologyData(page);
