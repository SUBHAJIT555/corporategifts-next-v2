...
export default function PremiumGiftSetsHero() {
  return (
    <section className="w-full bg-canvas">
      <RevealSection className="relative mx-auto max-w-7xl overflow-hidden border-x border-hairline px-3 pt-20 pb-10 sm:px-4 sm:pt-24 sm:pb-12 md:px-6 md:pt-32 md:pb-14 lg:pt-36">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            Buy Premium Gift Sets in Dubai{" "}
            <span className="text-brand-accent">
              Luxury Gift Boxes &amp; Hampers
            </span>
          </Reveal>
          ...
          >
            Find the Perfect Gift Set in Dubai – From Luxury Perfume Collections
            to Elegant Corporate Gift Boxes.
          </Reveal>
