    ...
    <section className="w-full bg-canvas">
      <RevealSection className="relative mx-auto max-w-7xl overflow-hidden border-x border-hairline px-3 pt-20 pb-10 sm:px-4 sm:pt-24 sm:pb-12 md:px-6 md:pt-32 md:pb-14 lg:pt-36">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            Explore a Wide Range of Premium Corporate Gifts in Dubai
          </Reveal>
          ...
          >
            Discover our curated collection of premium corporate gifts across
            apparel, tech, travel, eco-friendly products, and more—designed to
            strengthen relationships and elevate your brand.
          </Reveal>

          <Reveal animationNum={3} className="mt-5 flex justify-center sm:mt-7">
            <NoPrefetchLink
              href="#product-varieties"
