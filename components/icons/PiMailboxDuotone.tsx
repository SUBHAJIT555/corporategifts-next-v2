export const PiMailboxDuotone = ({ className }: { className?: string }) => (
    <svg
        viewBox="0 0 256 256"
        fill="currentColor"
        className={className}
    >
        ...
        <path d="M232,116v60a8,8,0,0,1-8,8H128V116A52,52,0,0,0,76,64H180A52,52,0,0,1,232,116Z" opacity="0.2"></path>
