      ...
      <RevealSection className="mx-auto max-w-7xl border-x border-hairline px-5 py-3 sm:px-6 sm:py-4 lg:py-4">
        <Reveal animationNum={0}>
          <div className="overflow-hidden rounded-2xl border border-hairline bg-surface-soft">
            <div className="border-b border-hairline bg-surface-soft px-5 py-4 sm:px-6 sm:py-5">
            ...
            <div className="grid bg-canvas lg:grid-cols-2">
              <div className="bg-surface-soft p-4 sm:p-5 lg:p-6">
                <div className="group relative min-h-[220px] overflow-hidden  sm:min-h-[280px] lg:min-h-[340px]">
                  <Image
                    src={imageUrl}
                    alt={imageAlt}
                    fill
                    ...
                    quality={100}
                  />
                  <div className="pointer-events-none absolute inset-0 rounded-xl bg-linear-to-t from-black/25 via-transparent to-transparent" />
                </div>
              </div>

              <div className="relative flex flex-col justify-center border-t border-hairline bg-surface-soft p-6 sm:p-8 lg:border-t-0 lg:border-l lg:p-10">
